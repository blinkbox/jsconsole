(function (window) {
    ...
    function run(cmd) {
        ...
        if (internalCmd) {
            ...
            try {
                if ('CoffeeScript' in sandboxframe.contentWindow) cmd = sandboxframe.contentWindow.CoffeeScript.compile(cmd, {
                    bare: true
                });
    ...
    document.addEventListener ? window.addEventListener('message', function (event) {
        post(event.data);
    }, false) : window.attachEvent('onmessage', function () {
